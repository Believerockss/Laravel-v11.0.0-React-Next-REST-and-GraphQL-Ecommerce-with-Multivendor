...
const SearchBar: React.FC<IProps> = ({}: IProps) => {
  ...
  return (
    <Fragment>
      ...
      {!isEmpty(searchItem) ? (
        <div className="sidebar-scrollbar shadow-box absolute top-12 z-30 h-[418px] max-h-[418px] w-full max-w-lg rounded-xl border border-solid border-gray-200 bg-white py-4 lg:top-[74px]">
          <Scrollbar
