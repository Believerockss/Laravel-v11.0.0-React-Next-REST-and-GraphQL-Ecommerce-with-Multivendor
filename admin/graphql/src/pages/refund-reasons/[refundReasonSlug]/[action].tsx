...
import { useRefundReasonQuery } from '@/graphql/refund-reason.graphql';
...
export default function UpdateRefundReasonPage() {
  ...
  const { data, loading, error } = useRefundReasonQuery({
    variables: {
  ...
  return (
    <>
      ...
      <CreateOrUpdateRefundReasonForm  initialValues={data?.refundReason as RefundReason} />
    </>
  );
}
