...
import { useProductsDraftQuery } from '@/graphql/products.graphql';
...
export default function ProductsPage() {
  ...
  const { data, loading, error, refetch } = useProductsDraftQuery({
    skip: !Boolean(shopId),
    variables: {
  ...
  }, [type, searchTerm, category, page, shopId]);
  ...
  return (
    <>
      ...
      <ProductList
        products={data?.productsDraft as ProductPaginator}
