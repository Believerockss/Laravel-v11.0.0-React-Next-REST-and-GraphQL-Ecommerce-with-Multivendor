...
class TermsAndConditionsController extends CoreController
{
    ...
    public function index(Request $request)
    {
        ...
        $termsAndConditions = $this->fetchTermsAndConditions($request)->where('language', $language)->paginate($limit)->withQueryString();
    ...
    public function fetchTermsAndConditions(Request $request)
    {
        ...
        try {
            ...
            // else statment is for global viewers level
